...
buildDubPackage (args // {
  ...
  extraDubDeps = [
    (makeDubDep { pname = "gitver"; version = "1.6.1"; hash = "sha256-KGLr/dRl/MOTMWCdPdtDqHX3eSiICNb/XMEmMEdbC3w="; })
    (makeDubDep { pname = "semver"; version = "0.3.2"; hash = "sha256-d+KkxfBb6Pf1R1FwJJH5RKpXhX6TlhmpKzmRXKzNrbc="; })
  ];
