...
BOOT_COUNTING_TRIALS = "@bootCountingTrials@"
...
class DiskEntry():
    ...
    def write(self) -> None:
        ...
        with tmp_path.open('w') as f:
            ...
            boot_entry = [
                          ...
                          f"sort-key {'default' if self.default else 'non-default'}"
                          ]
    ...
    def path(self) -> Path:
        ...
        return Path(f"{EFI_SYS_MOUNT_POINT}/loader/entries/{prefix}{self.counters if self.counters else ''}.conf")
...
def write_entry(profile: str | None, generation: int, specialisation: str | None,
                machine_id: str, bootspec: BootSpec, entries: List[DiskEntry], current: bool) -> None:
    if specialisation:
    ...
    counters = f"+{BOOT_COUNTING_TRIALS}" if BOOT_COUNTING else ""
